...
// import { RSearchPostsProps } from '../../../../types/props';
...
// const RSearchPosts = ({ keyword }: RSearchPostsProps) => {
...
//     queryKey: [`search${queryKey}`, pathname],
...
// //   useEffect(() => {
// //     queryClient.invalidateQueries([`search${queryKey}`, pathname]);
// //   }, [keyword]);
